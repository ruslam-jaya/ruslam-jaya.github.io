...
var URLS = 'https://info.ruslam.id/';

const NOT_FOUND_CACHE_FILES = 'https://info.ruslam.id/';
const CACHE_NAME = 'CACHE_OFFLINE_APP_RUSLAM';
const OFFLINE_URL = 'https://info.ruslam.id/';
const NOT_FOUND_URL = 'https://info.ruslam.id/';
...
const offlineFallbackPage = "https://info.ruslam.id/";
